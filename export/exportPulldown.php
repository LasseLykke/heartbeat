...
if (isset($_SESSION['user_id']) && isset($_SESSION['user_name'])) {
  ...
  <div class="wrapper">
    <section class="hbHeader">
      <h1 class="headerText">Pulldown</h1>
    </section>
    ...
    <script>
      ...
      const formattedDates = pulldownRepData.map((data) => {
      ...
      const workoutLineChart = new Chart(ctx, {
        ...
        data: {
          ...
          datasets: [
            {
              label: "Reps",
              data: pulldownRepData.map((data) => data.y), // Brug kun y-værdierne (reps)
      ...
      setTimeout(function () {
        ...
        const lastIndex = pulldownRepData.length - 1;

        // Beregn scroll-position
        const scrollPosition = (totalWidth / pulldownRepData.length) * lastIndex;
