...
if (isset($_SESSION['user_id']) && isset($_SESSION['user_name'])) {
  ...
  <head>
    ...
    <title>H E A R T B E A T || BICEPS STATS </title>
  </head>
  ...
  <div class="wrapper">
    <section class="hbHeader">
      <h1 class="headerText">Biceps statestik</h1>
    </section>
    ...
    <section class="wrapper">
      <div class="export-charts">
        <div class="chart-container">
          ...
          $sql = "SELECT DATE_FORMAT(ws.sessionDate, '%Y-%m-%d') AS date, wa.bicepsRep, wa.bicepsKilo
                            FROM woBiceps AS wa
        ...
        <script>
          ...
          const bicepsRepData = <?php echo json_encode($bicepsRepData); ?>;
          const bicepsKiloData = <?php echo json_encode($bicepsKiloData); ?>;
    ...
    <script>
      ...
      const formattedDates = bicepsRepData.map((data) => {
      ...
      const workoutLineChart = new Chart(ctx, {
        ...
        data: {
          ...
          datasets: [
            {
              label: "Reps",
              data: bicepsRepData.map((data) => data.y), // Brug kun y-værdierne (reps)
            ...
            {
              label: "Kilo",
              data: bicepsKiloData.map((data) => data.y), // Brug kun y-værdierne (kilo)
      ...
      setTimeout(function () {
        ...
        const lastIndex = bicepsRepData.length - 1;

        // Beregn scroll-position
        const scrollPosition = (totalWidth / bicepsRepData.length) * lastIndex;
