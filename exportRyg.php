...
if (isset($_SESSION['user_id']) && isset($_SESSION['user_name'])) {
    ...
    <head>
        ...
        <title>H E A R T B E A T || RYG STATS </title>
    </head>
    ...
    <div class="wrapper">
        <section class="hbHeader">
            <h1 class="headerText">Rygbøjning statestik</h1>
        </section>
...
const formattedDates = rygRepData.map((data) => {
...
setTimeout(function () {
  ...
  const lastIndex = rygRepData.length - 1;

  // Beregn scroll-position
  const scrollPosition = (totalWidth / rygRepData.length) * lastIndex;
