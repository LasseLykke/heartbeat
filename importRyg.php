...
if (isset($_SESSION['user_id']) && isset($_SESSION['user_name'])) {
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        $rygKilo = isset($_POST["rygKilo"]) ? intval($_POST["rygKilo"]) : 0;
        ...
        try {
            ...
            $stmt->bind_param("iii", $sessionID, $rygRep, $rygKilo);
            $stmt->execute();
...
<head>
    ...
    <title>H E A R T B E A T || Rygbøjning </title>
</head>
<body>
    ...
    <div class="wrapper">
        <section class="hbHeader">
            ...
            <section class="workoutlabel">
                ...
                <input type="number" id="rygKilo" name="rygKilo" placeholder="Kilo:">
            </section>
