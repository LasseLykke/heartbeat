...
if (isset($_SESSION['user_id']) && isset($_SESSION['user_name'])) {
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        try {
            ...
            $sql = "INSERT INTO woVand (sessionID, vand) VALUES (?, ?)";
            $stmt = $mysqli->prepare($sql);
            ...
            $stmt->bind_param("is", $sessionID, $vand);
            $stmt->execute();
...
<head>
    ...
    <title>H E A R T B E A T || Vand </title>
</head>
...
<body>
    ...
    <div class="wrapper">
        <section class="hbHeader">
            <h1 class="headerText">Vand indtaget</h1>
        </section>
        <form class="workoutForm" action="" method="POST">

            <section class="workoutlabel">
                <label for="vand"></label>
                <input type="text" id="vand" name="vand" placeholder="Liter:" required>
            </section>
